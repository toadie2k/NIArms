...
class hlc_30rnd_68x43_MIRDIM : hlc_30rnd_68x43_FMJ
{
    ...
    author = "Toadie,Spartan0536";
		...
		displayname = "PMAG (FMJ/IRDIM) 6.8mm";
		lastroundstracer = 4;
		scope = 2;
		tracersevery = 3;
...
class hlc_30rnd_68x43_MFMJ : hlc_30rnd_68x43_FMJ
{
    ...
    displayname = "PMAG (FMJ/Tracer) 6.8mm";
    lastroundstracer = 4;
    scope = 2;
    tracersevery = 3;
...
class hlc_30rnd_68x43_Sub : hlc_30rnd_68x43_Tracer
{
    ...
    displayname = "PMAG (Subsonic) 6.8mm";
    lastroundstracer = 4;
    scope = 2;
    tracersevery = 1;
