class CfgSoundShaders {
    ...
    class M1903a1_tailForest_SoundShader {
        samples[] = {
            { "\A3\Sounds_F_Mark\arsenal\weapons\LongRangeRifles\DMR_05_Cyrus\DMR05_tailforest", 1 }
        };
    ...
    class M1903a1_tailHouses_SoundShader {
        samples[] = {
            { "\A3\Sounds_F_Mark\arsenal\weapons\LongRangeRifles\DMR_05_Cyrus\DMR05_tailhouses", 1 }
        };
    ...
    class M1903a1_tailInterior_SoundShader {
        samples[] = {
            { "hlc_wp_springfield\snd\soundshaders\1903A1_indoor", 1 }
        };
        volume = "interior";
        range = 350;
        rangeCurve[] = {
    ...
    class M1903a1_tailMeadows_SoundShader {
        samples[] = {
            { "\A3\Sounds_F_Mark\arsenal\weapons\LongRangeRifles\DMR_05_Cyrus\DMR05_tailmeadows", 1 }
        };
    ...
    class M1903a1_tailTrees_SoundShader {
        samples[] = {
            { "\A3\Sounds_F_Mark\arsenal\weapons\LongRangeRifles\DMR_05_Cyrus\DMR05_tailtrees", 1 }
        };
