...
class CfgWeapons
{
    ...
    class hlc_rifle_416D145 : hlc_HK416_base
    {
        ...
        UiPicture = "\A3\weapons_f\data\UI\icon_regular_CA.paa";
        displayName = $STR_NIA_416145; /*(Compact/Tan)*/
        descriptionShort = $STR_NIA_D145_DESC;
        recoil = "recoil_trg20";
    ...
    class hlc_rifle_416D145_tan : hlc_rifle_416D145
    {
        ...
        UiPicture = "\A3\weapons_f\data\UI\icon_regular_CA.paa";
        displayName = $STR_NIA_416145_Tan; /*(Compact/Tan)*/
        dlc = "Niarms_HK416";
        descriptionShort = $STR_NIA_D145_DESC;
        discretedistanceinitindex = 0;
        cameraDir = "eye_look";
    ...
    class hlc_rifle_416D145_wdl : hlc_rifle_416D145
    {
        ...
        UiPicture = "\A3\weapons_f\data\UI\icon_regular_CA.paa";
        displayName = $STR_NIA_416145_Woodland; /*(Compact/Tan)*/
    ...
    class hlc_rifle_416D145_CAG : hlc_rifle_416D145
    {
        ...
        UiPicture = "\A3\weapons_f\data\UI\icon_regular_CA.paa";
        displayName = $STR_NIA_416145_CAG; /*(Compact/Tan)*/
        dlc = "Niarms_HK416";
        descriptionShort = $STR_NIA_D145_DESC;
        discretedistanceinitindex = 0;
        cameraDir = "eye_look";
    ...
    class hlc_rifle_416D145C : hlc_rifle_416D145
    {
        ...
        UiPicture = "\A3\weapons_f\data\UI\icon_regular_CA.paa";
        displayName = $STR_NIA_416145c; /*(Compact/Tan)*/
        dlc = "Niarms_HK416";
        descriptionShort = $STR_NIA_D145_DESC;
        discretedistanceinitindex = 0;
        cameraDir = "eye_look";
    ...
    class hlc_rifle_416D145_gl : hlc_rifle_416D145
    {
        dlc = "Niarms_HK416";
        author = "Toadie";
        displayName = $STR_NIA_416145_GL; /*(Compact/Tan)*/
    ...
    class hlc_rifle_416D10 : hlc_rifle_416D145
    {
        ...
        UiPicture = "\A3\weapons_f\data\UI\icon_regular_CA.paa";
        displayName = $STR_NIA_41610; /*(Compact/Tan)*/
        descriptionShort = $STR_NIA_D145_DESC;
        recoil = "recoil_trg20";
        discretedistance[] = {100, 200, 300, 400};
        discreteDistanceCameraPoint[] = {"eye", "eye_200", "eye_300", "eye_400"}; /// the angle of gun changes with zeroing
    ...
    class hlc_rifle_416D10_tan : hlc_rifle_416D10
    {
        ...
        UiPicture = "\A3\weapons_f\data\UI\icon_regular_CA.paa";
        displayName = $STR_NIA_41610_Tan; /*(Compact/Tan)*/
        dlc = "Niarms_HK416";
        descriptionShort = $STR_NIA_D145_DESC;
        discretedistanceinitindex = 0;
        cameraDir = "eye_look";
    ...
    class hlc_rifle_416D10_wdl : hlc_rifle_416D10
    {
        ...
        UiPicture = "\A3\weapons_f\data\UI\icon_regular_CA.paa";
        displayName = $STR_NIA_41610_Woodland; /*(Compact/Tan)*/
        dlc = "Niarms_HK416";
        descriptionShort = $STR_NIA_D145_DESC;
        discretedistanceinitindex = 0;
        cameraDir = "eye_look";
    ...
    class hlc_rifle_416D10_gl : hlc_rifle_416D10
    {
        ...
        author = "Toadie";
        scope = public;
        displayName = $STR_NIA_41610_GL; /*(Compact/Tan)*/
        handAnim[] = {"OFP2_ManSkeleton", "nia_wp_HK416\anim\handpose_AGC.rtm"};
    ...
    class hlc_rifle_416D10C : hlc_rifle_416D10
    {
        ...
        UiPicture = "\A3\weapons_f\data\UI\icon_regular_CA.paa";
        dlc = "Niarms_HK416";
        displayName = $STR_NIA_41610c; /*(Compact/Tan)*/
        descriptionShort = $STR_NIA_D145_DESC;
        discretedistanceinitindex = 0;
        cameraDir = "eye_look";
        recoil = "recoil_trg20";
    ...
    class hlc_rifle_416D10C_PTC : hlc_rifle_416D10
    {
        ...
        picture = "\nia_WP_HK416\tex\ui\gear_416D10c_ca";
        UiPicture = "\A3\weapons_f\data\UI\icon_regular_CA.paa";
        displayName = $STR_NIA_416D10C_PTC; /*(Compact/Tan)*/
        dlc = "Niarms_HK416";
        descriptionShort = $STR_NIA_D145_DESC;
        discretedistanceinitindex = 0;
        cameraDir = "eye_look";
    ...
    class hlc_rifle_416D10_RAHG : hlc_rifle_416D10
    {
        ...
        UiPicture = "\A3\weapons_f\data\UI\icon_regular_CA.paa";
        displayName = $STR_NIA_416D10_RAHG; /*(Compact/Tan)*/
        dlc = "Niarms_HK416";
        descriptionShort = $STR_NIA_D145_DESC;
    ...
    class hlc_rifle_416D10_geissele : hlc_rifle_416D10_RAHG
    {
        ...
        UiPicture = "\A3\weapons_f\data\UI\icon_regular_CA.paa";
        dlc = "Niarms_HK416";
        displayName = $STR_NIA_416D10_Geisele; /*(Compact/Tan)*/
        descriptionShort = $STR_NIA_D145_DESC;
    ...
    class hlc_rifle_416D10_ptato : hlc_rifle_416D10_geissele
    {
        ...
        UiPicture = "\A3\weapons_f\data\UI\icon_regular_CA.paa";
        displayName = $STR_NIA_416D10_Murphy; /*(Compact/Tan)*/
        dlc = "Niarms_HK416";
        descriptionShort = $STR_NIA_Potato_DESC;
    ...
    class hlc_rifle_416D10_st6 : hlc_rifle_416D10_RAHG
    {
        ...
        UiPicture = "\A3\weapons_f\data\UI\icon_regular_CA.paa";
        displayName = $STR_NIA_41610_DEVGRU; /*(Compact/Tan)*/
        dlc = "Niarms_HK416";
        descriptionShort = $STR_NIA_D145_DESC;
        discretedistance[] = {200, 300, 400, 500, 600};
        discreteDistanceCameraPoint[] = {"eye", "eye_300", "eye_400", "eye_500", "eye_600"}; /// the angle of gun changes with zeroing
    ...
    class hlc_rifle_416C : hlc_rifle_416D10
    {
        ...
        displayName = $STR_NIA_416C; /*(Compact/Tan)*/
        descriptionShort = $STR_NIA_416C_DESC;
    ...
    class hlc_rifle_BAB : hlc_rifle_416C
    {
        ...
        inertia = 0.295;
        __DEXTERITY(2.95, 0);                  //afg,kx3
        displayName = $STR_NIA_416C_BAB; /*(Compact/Tan)*/
        hiddenSelections[] = {"416_upper", "416_lower", "416C_extension", "416_mainparts", "416C_Foregrip"};
    ...
    class hlc_rifle_M27IAR : hlc_rifle_416D145
    {
        ...
        UiPicture = "\A3\weapons_f\data\UI\icon_regular_CA.paa";
        displayName = $STR_NIA_M27;
        descriptionShort = $STR_NIA_M27_DESC;
        recoil = "recoil_trg20";
    ...
    class hlc_rifle_416D165 : hlc_rifle_416D145
    {
        ...
        UiPicture = "\A3\weapons_f\data\UI\icon_regular_CA.paa";
        displayName = $STR_NIA_416165;
        descriptionShort = $STR_NIA_D165_DESC;
        recoil = "recoil_trg20";
        discretedistanceinitindex = 0;
        cameraDir = "eye_look";
        bg_bipod = 0;
    ...
    class hlc_rifle_416D165_tan : hlc_rifle_416D165
    {
        ...
        UiPicture = "\A3\weapons_f\data\UI\icon_regular_CA.paa";
        displayName = $STR_NIA_416165_Tan; /*(Compact/Tan)*/
        descriptionShort = $STR_NIA_D165_DESC;
        discretedistanceinitindex = 0;
        cameraDir = "eye_look";
        recoil = "recoil_trg20";
    ...
    class hlc_rifle_416D165_wdl : hlc_rifle_416D165
    {
        ...
        UiPicture = "\A3\weapons_f\data\UI\icon_regular_CA.paa";
        displayName = $STR_NIA_416165_Woodland; /*(Compact/Tan)*/
        descriptionShort = $STR_NIA_D165_DESC;
        discretedistanceinitindex = 0;
        cameraDir = "eye_look";
        recoil = "recoil_trg20";
    ...
    class hlc_rifle_416D165_gl : hlc_rifle_416D165
    {
        ...
        author = "Toadie";
        scope = public;
        displayName = $STR_NIA_416165_GL; /*(Compact/Tan)*/
        handAnim[] = {"OFP2_ManSkeleton", "nia_wp_HK416\anim\handpose_AGC.rtm"};
    ...
    class hlc_rifle_416N : hlc_rifle_416D165
    {
        ...
        displayName = $STR_NIA_416N; /*(Compact/Tan)*/
        dlc = "Niarms_HK416";
        inertia = 0.33;
    ...
    class hlc_rifle_416N_gl : hlc_rifle_416N
    {
        ...
        author = "Toadie";
        scope = public;
        displayName = $STR_NIA_416N_GL; /*(Compact/Tan)*/
        handAnim[] = {"OFP2_ManSkeleton", "nia_wp_HK416\anim\handpose_AGC.rtm"};
    ...
    class hlc_rifle_416D20_tan : hlc_rifle_416D20
    {
        ...
        UiPicture = "\A3\weapons_f\data\UI\icon_regular_CA.paa";
        displayName = $STR_NIA_41620_Tan; /*(Compact/Tan)*/
        descriptionShort = $STR_NIA_D165_DESC;
        discretedistanceinitindex = 0;
        cameraDir = "eye_look";
        recoil = "recoil_trg20";
    ...
    class hlc_rifle_416D20_wdl : hlc_rifle_416D20
    {
        ...
        UiPicture = "\A3\weapons_f\data\UI\icon_regular_CA.paa";
        displayName = $STR_NIA_41620_Woodland; /*(Compact/Tan)*/
        descriptionShort = $STR_NIA_D165_DESC;
        discretedistanceinitindex = 0;
        cameraDir = "eye_look";
        recoil = "recoil_trg20";
