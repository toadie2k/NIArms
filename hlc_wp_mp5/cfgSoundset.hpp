...
class CfgSoundSets
{
	...
	{
		soundShaders[] = { "mp5_tailDistant_SoundShader", "mp5_tailTrees_SoundShader", "mp5_tailForest_SoundShader", "mp5_tailMeadows_SoundShader", "mp5_tailHouses_SoundShader", "mp5_tailInterior_SoundShader" };
		volumeFactor = 0.6;
	...
	{
		soundShaders[] = { "mp5_silencerShot_SoundShader", "mp5_Closure_SoundShader" };
		volumeFactor = 1;
		volumeCurve = "InverseSquare2Curve";
		spatial = 1;
		doppler = 0;
	...
	{
		soundShaders[] = { "mp5sd_silencerShot_SoundShader", "mp5_Closure_SoundShader" };
		volumeFactor = 1;
		volumeCurve = "InverseSquare2Curve";
		spatial = 1;
		doppler = 0;
	...
	{
		soundShaders[] = { "mp5k_tailDistant_SoundShader", "mp5k_tailTrees_SoundShader", "mp5k_tailForest_SoundShader", "mp5k_tailMeadows_SoundShader", "mp5k_tailHouses_SoundShader", "mp5k_tailInterior_SoundShader" };
		volumeFactor = 0.6;
		volumeCurve = "InverseSquare2Curve";
		spatial = 1;
		doppler = 0;
	...
	{
		soundShaders[] = { "9mmar_tailDistant_SoundShader", "9mmar_tailTrees_SoundShader", "9mmar_tailForest_SoundShader", "9mmar_tailMeadows_SoundShader", "9mmar_tailHouses_SoundShader", "9mmar_tailInterior_SoundShader" };
		volumeFactor = 0.6;
		volumeCurve = "InverseSquare2Curve";
		spatial = 1;
		doppler = 0;
	...
	{
		soundShaders[] = { "mp510_closeShot_SoundShader", "mp510_midShot_SoundShader", "mp510_distShot_SoundShader", "mp5_Closure_SoundShader" };
		volumeFactor = 1.6;
		volumeCurve = "InverseSquare3Curve";
		spatial = 1;
		doppler = 0;
	...
	{
		soundShaders[] = { "mp510_tailDistant_SoundShader", "mp510_tailTrees_SoundShader", "mp510_tailForest_SoundShader", "mp510_tailMeadows_SoundShader", "mp510_tailHouses_SoundShader", "mp510_tailInterior_SoundShader" };
		volumeFactor = 0.6;
		volumeCurve = "InverseSquare2Curve";
		spatial = 1;
		doppler = 0;
	...
	{
		soundShaders[] = { "mp510_silencerShot_SoundShader", "mp5_Closure_SoundShader" };
		volumeFactor = 1;
		volumeCurve = "InverseSquare2Curve";
		spatial = 1;
		doppler = 0;
