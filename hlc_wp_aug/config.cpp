// config.bin - 20:48:24 08/03/16, generated in 0.06 seconds
...
class CfgSoundShaders {
	...
	class aug_closeShot_SoundShader {
		samples[] = {{"hlc_wp_aug\snd\soundshaders\aug\aug_close", 1}, {"hlc_wp_aug\snd\soundshaders\aug\aug_close", 1}};
		volume = 0.9;
		range = 50;
	...
	class aug_tailForest_SoundShader {
		samples[] = {{"hlc_wp_aug\snd\soundshaders\ar556_forest", 1}};
	...
	class aug_tailInterior_SoundShader {
		samples[] = {{"hlc_wp_aug\snd\soundshaders\aug\aug_indoor", 1}};
		volume = "interior";
		range = 350;
	...
	class augcarbine_closeShot_SoundShader {
		samples[] = {{"hlc_wp_aug\snd\soundshaders\aug\augcarbine_close", 1}, {"hlc_wp_aug\snd\soundshaders\aug\augcarbine_close", 1}};
		volume = 0.9;
		range = 50;
		rangeCurve = "closeShotCurve";
	};
	...
	class augcarbine_midShot_SoundShader {
		samples[] = {{"hlc_wp_aug\snd\soundshaders\aug\augcarbine_mid", 1}};
		volume = 0.707946;
		range = 2000;
		rangeCurve[] = {{0, 0.2}, {50, 1}, {300, 0}, {2000, 0}};
	};
	...
	class augcarbine_tailMeadows_SoundShader {
		samples[] = {{"hlc_wp_aug\snd\soundshaders\aug\augcarbine_meadow", 1}, {"hlc_wp_aug\snd\soundshaders\aug\augcarbine_meadow", 1}};
		volume = "(1-interior/1.4)*(meadows/2 max sea/2)/3";
		range = 2000;
		rangeCurve[] = {{0, 1}, {2000, 0}};
		limitation = 1;
	...
	class aughbar_closeShot_SoundShader {
		samples[] = {{"hlc_wp_aug\snd\soundshaders\aug\aughbar_close", 1}, {"hlc_wp_aug\snd\soundshaders\aug\aughbar_close", 1}};
		volume = 1.0;
		range = 50;
		rangeCurve = "closeShotCurve";
	};
	...
	class aughbar_midShot_SoundShader {
		samples[] = {{"hlc_wp_aug\snd\soundshaders\aug\aughbar_mid", 1}};
		volume = 0.707946;
		range = 2000;
		rangeCurve[] = {{0, 0.2}, {50, 1}, {300, 0}, {2000, 0}};
	};
	...
	class aughbar_tailMeadows_SoundShader {
		samples[] = {{"hlc_wp_aug\snd\soundshaders\aug\aughbar_meadow", 1}, {"hlc_wp_aug\snd\soundshaders\aug\aughbar_meadow", 1}};
		volume = "(1-interior/1.4)*(meadows/2 max sea/2)/3";
		range = 2000;
		rangeCurve[] = {{0, 1}, {2000, 0}};
		limitation = 1;
	...
	class augpara_tailForest_SoundShader {
		samples[] = {{"hlc_wp_aug\snd\soundshaders\aug9mm_forest", 1}};
		volume = "(1-interior/1.4)*forest/3";
		range = 1500;
	...
	class augpara_tailInterior_SoundShader {
		samples[] = {{"hlc_wp_aug\snd\soundshaders\AUGpara\augpara_indoor", 1}};
		volume = "interior";
		range = 350;
		rangeCurve[] = {{0, 1}, {50, 0.4}, {100, 0.2}, {350, 0}};
		limitation = 1;
...
class asdg_UnderSlot;	// External class reference
class asdg_MuzzleSlot;	// External class reference
class asdg_MuzzleSlot_556;	// External class reference
class asdg_MuzzleSlot_762;	// External class reference
...
class CfgWeapons {
	...
	class hlc_rifle_aug : hlc_aug_base {
		...
		class FullAuto : Mode_FullAuto {
			...
			soundBegin[] = {"begin1", 0.5, "begin2", 0.5};
			closure1[] = {"hlc_wp_aug\snd\f88a1_first", 3.16228, 1, 30};
			closure2[] = {"hlc_wp_aug\snd\f88a1_first", 3.16228, 1, 30};
			soundClosure[] = {"closure1", 0.5, "closure2", 0.5};
	...
	class hlc_rifle_auga3_GL : hlc_rifle_aug {
		...
		class hlc_M203_AUGA3 : UGL_F {
			...
			discreteDistanceCameraPoint[] = {"GL Eye1", "GL Eye15", "GL Eye2", "GL Eye25", "GL Eye3", "GL Eye35", "GL Eye4", "GL Eye45"};
