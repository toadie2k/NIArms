...
class CfgSoundSets
{
	...
	{
		soundShaders[] = { "aug_tailDistant_SoundShader", "aug_tailForest_SoundShader", "aug_tailHouses_SoundShader", "aug_tailInterior_SoundShader", "aug_tailMeadows_SoundShader", "aug_tailTrees_SoundShader" };
		volumeFactor = 1;
		volumeCurve = "InverseSquare2Curve";
		spatial = 1;
		doppler = 0;
	...
	{
		soundShaders[] = { "aug_silencerShot_SoundShader", "aug_Closure_SoundShader" };
		volumeFactor = 1;
		volumeCurve = "InverseSquare2Curve";
		spatial = 1;
		doppler = 0;
	...
	{
		soundShaders[] = { "augcarbine_tailDistant_SoundShader", "augcarbine_tailForest_SoundShader", "augcarbine_tailHouses_SoundShader", "augcarbine_tailInterior_SoundShader", "augcarbine_tailMeadows_SoundShader", "augcarbine_tailTrees_SoundShader" };
		volumeFactor = 1;
		volumeCurve = "InverseSquare2Curve";
		spatial = 1;
		doppler = 0;
	...
	{
		soundShaders[] = { "augcarbine_silencerShot_SoundShader", "augcarbine_Closure_SoundShader" };
		volumeFactor = 1;
		volumeCurve = "InverseSquare2Curve";
		spatial = 1;
		doppler = 0;
	...
	{
		soundShaders[] = { "aughbar_tailDistant_SoundShader", "aughbar_tailForest_SoundShader", "aughbar_tailHouses_SoundShader", "aughbar_tailInterior_SoundShader", "aughbar_tailMeadows_SoundShader", "aughbar_tailTrees_SoundShader" };
		volumeFactor = 1;
		volumeCurve = "InverseSquare2Curve";
		spatial = 1;
		doppler = 0;
	...
	{
		soundShaders[] = { "aughbar_silencerShot_SoundShader", "aughbar_Closure_SoundShader" };
		volumeFactor = 1;
		volumeCurve = "InverseSquare2Curve";
		spatial = 1;
		doppler = 0;
	...
	{
		soundShaders[] = { "augpara_tailDistant_SoundShader", "augpara_tailTrees_SoundShader", "augpara_tailForest_SoundShader", "augpara_tailMeadows_SoundShader", "augpara_tailHouses_SoundShader", "augpara_tailInterior_SoundShader" };
		volumeFactor = 0.6;
		volumeCurve = "InverseSquare2Curve";
		spatial = 1;
		doppler = 0;
	...
	{
		soundShaders[] = { "augpara_silencerShot_SoundShader" };
		volumeFactor = 1;
		volumeCurve = "InverseSquare2Curve";
		spatial = 1;
		doppler = 0;
